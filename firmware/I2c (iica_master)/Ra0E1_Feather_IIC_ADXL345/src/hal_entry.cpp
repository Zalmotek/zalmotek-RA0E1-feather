...
void hal_entry(void)
{
    ...
    while (true)
    {
        ...
        // Process the raw sensor data into x, y, z axis values
        x_axis = (float)(xyz_axis[0] | (xyz_axis[1] << 8));
        y_axis = (float)(xyz_axis[2] | (xyz_axis[3] << 8));
        z_axis = (float)(xyz_axis[4] | (xyz_axis[5] << 8));

        // Check if sensor data is valid
        if ((int)x_axis == 0 && (int)y_axis == 0 && (int)z_axis == 0) {
            APP_PRINT("Invalid sensor data.\n");
            i2cok = 0;
        }
